...
Pod::Spec.new do |s|
  s.name             = 'LovePlay'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LovePlay.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/YunsChou/LovePlay'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'YunsChou' => '2647754496@qq.com' }
  s.source           = { :git => 'https://github.com/YunsChou/LovePlay.git', :tag => s.version.to_s }
